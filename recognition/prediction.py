...
def faceDetectionFromPath(path, size):
    ...
    facerect = cascade.detectMultiScale(cvImg, scaleFactor=1.1, minNeighbors=4, minSize=(1, 1))
    faceData = []
...
def main():
    ...
    # モデルの指定(相対パスにする)
    parser.add_argument('--model', '-m', default='/Users/kawanohenkenji/private/study/openCV_practice/mymodel.h5', required=True)
    # 予測ファイルの指定(相対パスにする)
    parser.add_argument('--testpath', '-t', default='/Users/kawanohenkenji/private/study/openCV_practice/images/kawanobe_test1.jpg')
